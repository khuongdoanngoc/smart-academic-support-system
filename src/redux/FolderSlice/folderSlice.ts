...
// const getAllFolders = createAsyncThunk<IFolder[]>('folder/getAllFolders', async () => {
//     const res = await GetAllFolders();
//     return res.data;
// })

// const createFolder = createAsyncThunk<IFolder, string>('folder/createFolder', async (folderName: string) => {
